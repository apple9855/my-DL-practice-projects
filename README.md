...
- 📊 Tabular Modeling (Regression, Recommendation)
...
- **Engineering**: Model selection based on data characteristics (e.g., tree vs. NN)
, Custom model classes, Low-level gradient descent, Deployment with HF Spaces  
...
## 🧭 My Journey (Auditor → Deep Learning Engineer)
...
> *“From audit reports to model reports, from spreadsheets to tensors.”*

---

## 💼 Get in Touch

If you're reviewing this as a potential employer or collaborator — thank you! I'm always open to connect, discuss ideas, or explore opportunities.